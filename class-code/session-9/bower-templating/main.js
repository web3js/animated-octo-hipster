...
app.main  = (function() {  
  ...
  var elements = {
    ...
    notesCount : document.querySelector('.note-count'),
  ...
  var attachEvents = function() {
    ...
    app.events.subscribe('onLike', updateLikeCount);
    app.events.subscribe('onNote', updateNoteCount);

  };

  var updateLikeCount = function() {
